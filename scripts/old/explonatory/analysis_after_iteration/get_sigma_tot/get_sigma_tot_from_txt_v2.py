...
def extrair_valores(linha):
    ...
    try:
        ...
        a2 = float(partes[7].split('±')[0].strip())
        return down, strategy, ncall, mg, eps, a1, a2
...
# === Caminhos ===
input_dir = 'results/all_possible_iterations/v4/all_possible_iterations_log_totem_v4'
...
for caminho_entrada in arquivos:
    ...
    with open(caminho_entrada, 'r') as arq, open(caminho_saida, 'w') as saida:
        ...
        for linha in arq:
            ...
            down, strategy, ncall, mg, eps, a1, a2 = dados
            m2_func = m2_log
            epsilon = eps
            s = sqrt_s ** 2
            ...
            try:
                ...
                saida.write(f"{down:.2f} | {strategy:.2f} | {ncall} | {sigma:.3f}\n")
            except Exception as e:
