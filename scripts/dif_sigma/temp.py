...
def main():
    mass_model_log = 'log'
    mass_model_pl = 'pl'
    ensemble = 'totem'  # Change to 'atlas' or 'totem' as needed
    n_points = 10000
    ...
    sqrt_s_values = [546, 1800, 13000]
    scale_factors = {546: 1, 1800: 10, 13000: 100}
    ...
    # Mostrar o gráfico
    save_plot(fig, f'dif_sigma_{ensemble}.html')
